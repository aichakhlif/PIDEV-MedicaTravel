...
class InterventionController extends Controller
{
    ...
    /**
     * @Route("/Afficheri", name="Afficheri")
     *
     */
    public function Afficher()
    {
        $intervention = $this->getDoctrine()->getRepository(intervention::class)->findAll();
        return $this->render('intervention/Afficheri.html.twig', array('listintervention' => $intervention));


    }

    /**
     * @Route("/addi", name="addintervention")
    ...
    public function add(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em->flush();
            return $this->redirectToRoute('Afficheri');
        }
        return $this->render("intervention/addi.html.twig", array("formintervention" => $form->createView()));
    }
